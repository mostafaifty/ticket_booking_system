...
@section('title', 'Edit Train - ' . $train->train_name)
@section('page_title', 'Edit Train Details')
        ...
        <div class="card card-outline card-primary shadow-sm">
            <div class="card-header">
                <h3 class="card-title font-weight-bold">
                    <i class="fas fa-edit mr-1 text-primary"></i> Edit Train: {{ $train->train_name }} (#{{ $train->train_number }})
                </h3>
            </div>
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('train_number', $train->train_number) }}" 
                                       maxlength="20" 
                                       required>
                                @error('train_number')
                        ...
                        <div class="col-md-7 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('train_name', $train->train_name) }}" 
                                       required>
                                @error('train_name')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="train_type" id="train_type" class="form-control @error('train_type') is-invalid @enderror" required>
                                <option value="Intercity" {{ old('train_type', $train->train_type) === 'Intercity' ? 'selected' : '' }}>Intercity Express</option>
                                <option value="Mail/Express" {{ old('train_type', $train->train_type) === 'Mail/Express' ? 'selected' : '' }}>Mail / Express</option>
                                <option value="Commuter" {{ old('train_type', $train->train_type) === 'Commuter' ? 'selected' : '' }}>Commuter / Local</option>
                            </select>
                            @error('train_type')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('total_seats', $train->total_seats) }}" 
                                       min="0" 
                                       max="2000" 
                                       required>
                                @error('total_seats')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                                <option value="active" {{ old('status', $train->status) === 'active' ? 'selected' : '' }}>Active (In Operation)</option>
                                <option value="maintenance" {{ old('status', $train->status) === 'maintenance' ? 'selected' : '' }}>Maintenance / Repair</option>
                                <option value="inactive" {{ old('status', $train->status) === 'inactive' ? 'selected' : '' }}>Inactive (Retired)</option>
                            </select>
                            @error('status')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
